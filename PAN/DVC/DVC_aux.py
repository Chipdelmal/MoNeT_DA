...
def selectPath(USR, DRV=None):
    if USR == 'srv':
        PATH_ROOT = '/RAID5/marshallShare/deVector/{}/'.format(DRV)
    elif USR == 'lab':
        PATH_ROOT = '/Volumes/marshallShare/deVector/{}/'.format(DRV)
    elif USR == 'dsk':
        PATH_ROOT = '/home/chipdelmal/Documents/WorkSims/deVector/{}/'.format(DRV)
    (PATH_IMG, PATH_DATA) = (
