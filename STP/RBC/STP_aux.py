...
DICE_PARS = (
    ('CPT', 0.005, '#4361ee43', (0, 1)),    ('WOP', 0.050, '#be0aff33', (0, XRAN[1])), 
    ('TTO', 0.050, '#ff006e22', (0, XRAN[1])), ('TTI', 0.075, '#23194233', (0, 150)),
    ('MNF', 0.000, '#00B3E643', (0, 1)),    ('POE', 0.001, '#fb560733', (0, 1))
)
# ML --------------------------------------------------------------------------
...
(ML_WOP_CATS, ML_TTI_CATS, ML_TTO_CATS) = (
    [-10, 365*.25, 365*.5, 365*.75, 365*1, 365*1.5, 365*2, 365*4, 365*6],
    [-10, 20, 40, 60, 90, 365*6],
