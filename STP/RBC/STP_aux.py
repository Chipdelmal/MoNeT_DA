...
DICE_PARS = (
    ...
    ('WOP', 0.050, '#be0aff33', (0, XRAN[1]/SAMP_RATE)),
    ('TTO', 0.050, '#9ef01a33', (0, XRAN[1]/SAMP_RATE)),
...
(ML_WOP_CATS, ML_TTI_CATS, ML_TTO_CATS) = (
    [-10, 365*1, 365*2, 365*3, 365*4, 365*5, 365*6, 365*7, 365*8, 365*9, 365*10, 365*11, 365*12],
    [-10, 60, 120, 365*12],
