...
DICE_PARS = (
    ...
    ('TTO', 0.050, '#ff006e22', None),  ('TTI', 0.075, '#23194233', (0, 150)),
    ('MNF', 0.000, '#00B3E643', None),  ('POE', 0.001, '#fb560733', None)
)
# ML --------------------------------------------------------------------------
...
(ML_WOP_CATS, ML_TTI_CATS, ML_TTO_CATS) = (
    [-10, 365*.5, 365*1, 365*1.5, 365*2, 365*4, 365*6],
    [-10, 60, 365*6],
...
SOUTH = [
    ...
    104, 111, 131, 102, 93, 96, 90, 115, 116, 132, 123, 129, 141
]
SITES = [
